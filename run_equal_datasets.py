...
def main():
    ...
    aqa = datasets.load_dataset('adversarial_qa', 'adversarialQA')
    aqa = aqa.remove_columns("metadata")

    squad_train = datasets.load_dataset('squad', split='train[:30000]')
    aqa_train = datasets.load_dataset('adversarial_qa', 'adversarialQA', split='train')
    aqa_train = aqa_train.remove_columns("metadata")
    ...
    if training_args.do_train:
        train_dataset = datasets.concatenate_datasets([squad_train, aqa_train])
    ...
    if training_args.do_eval:
        eval_dataset = datasets.concatenate_datasets([squad['validation'], aqa['validation']])
